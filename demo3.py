...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('C:/Users/Public/Documents\AI using Python [Pantech Solutions]/Deep Learning/character rcognition/Code-15/Dataset/train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('C:/Users/Public/Documents\AI using Python [Pantech Solutions]/Deep Learning/character rcognition/Code-15/Dataset/val',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
